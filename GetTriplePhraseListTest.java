...
public class GetTriplePhraseListTest {
	...
	public static ArrayList<TriplePhrase> getTriplePhrase(ArrayList<Phrase> phraseList) {
		GetTriplePhraseListTest.phraseList = new ArrayList<Phrase>();
		ArrayList<TriplePhrase> triplePhraseList = new ArrayList<TriplePhrase>();

		triplePhrase = new TriplePhrase();
		GetTriplePhraseListTest.phraseList = phraseList;
		...
		if(triplePhrase.getTargetPhraseList() != null && triplePhrase.getEffectPhrase() != null){
